      ...
      <Grid container spacing={6}>
        <Grid item sx={{ maxWidth: "100%", width: "calc(100% - 350px)" }}>
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to SHOWZONE LLC.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to ShowZone, accessible from{" "}
                <Link
                  href="https://showzone.io"
          ...
          <p id="cookieP">
            ...
            devices for measuring advertising effectiveness and ensuring a
            robust online advertising industry. The Common ID cookie stores a
            unique user id in the first party domain and is accessible to our ad
            partners. This simple ID that can be utilized to improve user
            matching, especially for delivering ads to iOS and MacOS browsers.
            Users can opt out of the Common ID tracking cookie by clicking{" "}
            <Link
          ...
          <ul>
            <li>By email: team@showzone.io</li>
          </ul>
        </Grid>
        <SidebarGeneric />
      </Grid>
