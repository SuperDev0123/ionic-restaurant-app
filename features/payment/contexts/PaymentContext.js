...
import getClientSecret from "../../../adapters/stripe/services/get-client-secret"
...
export const PaymentProvider = ({ children }) => {
  ...
  const pay = useCallback(
    async values => {
      const { numberOfLogos } = values
      const clientSecret = await getClientSecret({ numberOfLogos })
