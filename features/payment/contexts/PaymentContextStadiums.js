...
import getClientSecret from "../../../adapters/stripe/services/get-client-secret-stadium"

const PaymentContext = createContext()

export const usePayment = () => useContext(PaymentContext)

export const PaymentProviderStadium = ({ children }) => {
  ...
  const pay = useCallback(
    async values => {
      const { stadiumPackage } = values
      const clientSecret = await getClientSecret({ stadiumPackage })
