...
const FieldingAttributes = props => {
      ...
      <StatRow>
        <StatBox className={`parallel-${props.parallel}`}>
          ...
          <Typography variant="h6" component="p">
            {props.player?.fielding_ability ?? ""}
          </Typography>
          { grabImage(props.player?.fielding_ability) }
        </StatBox>
        <StatBox className={`parallel-${props.parallel}`}>
          <Typography className="stat-title" component="p">
            ARM STR
          ...
          <Typography variant="h6" component="p">
            {props.player?.arm_strength ?? ""}
          </Typography>
          { grabImage(props.player?.arm_strength) }
        </StatBox>
        <StatBox className={`parallel-${props.parallel}`}>
          <Typography className="stat-title" component="p">
            ARM ACC
          ...
          <Typography variant="h6" component="p">
            {props.player?.arm_accuracy ?? ""}
          </Typography>
          { grabImage(props.player?.arm_accuracy) }
        </StatBox>
        <StatBox className={`parallel-${props.parallel}`}>
          <Typography className="stat-title" component="p">
            REAC
          ...
          <Typography variant="h6" component="p">
            {props.player?.reaction_time ?? ""}
          </Typography>
          { grabImage(props.player?.reaction_time) }
        </StatBox>
        <StatBox className={`parallel-${props.parallel}`}>
          <Typography className="stat-title" component="p">
            BLOCK
          ...
          <Typography variant="h6" component="p">
            {props.player?.blocking ?? ""}
          </Typography>
          { grabImage(props.player?.blocking) }
        </StatBox>
      </StatRow>
    </CardContent>
  </Card>
...
export default FieldingAttributes
